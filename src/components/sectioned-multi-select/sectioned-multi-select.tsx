...
class SectionedMultiSelect extends PureComponent {
  ...
  _displaySelectedItems = () => {
    ...
    return selectedItems.map((singleSelectedItem) => {
      const item = this._findItem(singleSelectedItem)
      const isParent = item && item[subKey] && item[subKey].length
      ...
      return (
          ...
          style={[
            {
              ...
              justifyContent: 'center',
              height: 34,
              borderColor: convertRGBToHex(getFontColorTone(0, item.color)),
              borderWidth: 1,
              borderRadius: 20,
              flexDirection: 'row',
              alignItems: 'center',
        ...
        >
          <Text
            ...
            style={[
              {
                color: convertRGBToHex(getFontColorTone(0, item.color)),
                fontSize: 13,
                marginRight: 0,
              },
              styles.chipText,
              ...
              style={
                {
                  ...
                  alignItems: 'center',
                  paddingVertical: 5,
                  borderColor: '#fff', borderWidth: 1, margin: 5, borderRadius: 5
                }}
            >
              ...
              {callIfFunction(selectToggleIconComponent) || (
                <Icon
                  ...
                  style={{ color: colors.selectToggleTextColor, marginRight: 20 }}
                />
              )}
            </View>
          </TouchableWithoutFeedback>
