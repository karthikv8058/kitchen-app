...
import { Platform, StyleSheet, Text, TouchableOpacity, Button, View, } from 'react-native';
...
export default class VideoPlayer extends Component {
    ...
    constructor(props) {
        ...
        this.onVideoFocus = this.onVideoFocus.bind(this)
        this.onVideoBlur = this.onVideoBlur.bind(this)
    }
    state = {
        rate: 1,
        volume: 1,
            ...
            <View style={styles.container}>
                <TouchableOpacity style={styles.fullScreen} onPress={() => { this.setState({ paused: !this.state.paused }) }}>
                    ...
                    autoPlay
                        ...
                        onVideoFocus={this.props.onVideoFocus}
                        onVideoBlur={this.props.onVideoBlur}
    ...
    render() { return this.state.controls ? this.renderNativeSkin() : this.renderCustomSkin(); }
}
