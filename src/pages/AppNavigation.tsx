...
//import DetectedRestuarants from './DetectedRestuarants';
import GuestGroupManagement from "../service_staff/pages/GuestGroupManagement";
import BillingPage from "../service_staff/pages/BillingPage";
import BillingPaymentPage from "../service_staff/pages/BillingPaymentPage";
import GuestList from "../service_staff/pages/GuestList";
  ...
  return (
    <NavigationContainer>
      ...
      >
        ...
        <Stack.Screen
          name="DetectedRestuarants"
          component={DetectedRestuarants}
        />
        <Stack.Screen
          name="AdvancedStartupPage"
          component={AdvancedStartupPage}
        />
        ...
        <Stack.Screen
          name="GuestGroupManagement"
          component={GuestGroupManagement}
        />
        <Stack.Screen name="GuestList" component={GuestList} />
        <Stack.Screen name="OrderOverview" component={OrderOverView} />
        <Stack.Screen
          name="OrientationSelectionPage"
          component={OrientationSelectionPage}
        />
